...
import { ExecuteSandbox, isSessionPageConnected, recoverSessionPage, runPlaywrightOperation, waitForPageContext } from "../src/execute.ts"
...
describe("execute lifecycle", () => {
  ...
  it.each([
    ...
    try {
      ...
      await Effect.runPromise(sandbox.disconnect())
      connect.mockRestore()
